...
export default async function ReputationalRiskPage({
  params,
}: {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      <TopBar title="sidebar.reputationalRisk">
        <div className="flex justify-between items-center w-full gap-2">
          <div className="flex flex-row items-center gap-2">
            ...
            <div className="flex flex-row items-center gap-1">
              ...
              <AssigneeSelector
                ...
                assignedTo={projectData?.reputationalRisk?.assignedTo || projectData?.carbonQualityAssessment?.assignedTo}
              />
            </div>
            <FinalRatingSelector
          ...
          <div className="flex items-center">
            <GenerateAssessmentButton
              currentUser={user?.fullName}
              assignee={projectData?.reputationalRisk?.assignedTo || projectData?.carbonQualityAssessment?.assignedTo}
            />
            <ThemeSwitcher />
          </div>
        </div>
