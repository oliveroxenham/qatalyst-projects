...
export default async function AdditionalityPage({
  params,
}: {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      <TopBar title="sidebar.additionality">
        <div className="flex justify-between items-center w-full gap-2">
          <div className="flex flex-row items-center gap-2">
            ...
            <div className="flex flex-row items-center gap-1">
              ...
              <AssigneeSelector
                ...
                assignedTo={projectData?.additionality?.assignedTo || projectData?.carbonQualityAssessment?.assignedTo}
              />
            </div>
            <FinalRatingSelector
          ...
          <div className="flex items-center">
            <GenerateAssessmentButton
              currentUser={user?.fullName}
              assignee={projectData?.additionality?.assignedTo || projectData?.carbonQualityAssessment?.assignedTo}
            />
            <ThemeSwitcher />
          </div>
        </div>
