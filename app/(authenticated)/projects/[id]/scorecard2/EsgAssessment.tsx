...
const Pill = ({ children, type }: { readonly children: React.ReactNode; readonly type: string }) => {
...
function EsgAssessment({risk = 'Low', data}: {risk: string, data: {id: number, satisfactory: boolean, title: string}[]}) {
          ...
          <TableBody>
            {data.map((item) => (
              <TableRow key={item.id}>
                ...
                <TableCell>
                  <Pill type={item.satisfactory ? 'satisfactory' : 'unsatisfactory'}>
